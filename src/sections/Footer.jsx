    ...
    <footer className="max-container">
      ...
      >
        <div className="flex flex-col items-start">
          <a href="/">
            <h3 className="text-4xl font-bold text-white">JoShoes</h3>
          </a>
          <p
            className="mt-6 text-base font-montserrat leading-7
          text-white-400 sm:max-w-sm"
          >
            Get shoes ready for the new term at your nearest JoShoes store. Find
